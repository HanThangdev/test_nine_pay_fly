...
import { imagePolicy } from '@/images';
    ...
    <>
      ...
      <div
        ...
        className={classNames(
          'bg-[#FFF] rounded-[10px] m-6 py-[22px] px-[29px]',
          'shadow-[0_0px_4px_0px_rgba(32,32,62,0.16)] font-sans',
        )}
      >
        <img src={imagePolicy} className="w-full mb-[20px]" />
        ...
        <p className="mb-4">
          {t('key.inforCollect', { ns: 'privacy_policy' })}
        </p>
        ...
        <p className="mb-2">
          {t('key.ourServiceMay', { ns: 'privacy_policy' })}
        </p>
