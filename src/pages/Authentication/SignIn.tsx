              ...
              <Link className="mb-5.5 inline-block" to="/">
                <p
                  className={classNames(
                    'text-[30px] text-white font-bold hidden dark:block',
                  )}
                >
                  Chatfly
                </p>
                <p
                  className={classNames(
                    'text-[30px] text-black font-bold dark:hidden',
                  )}
                >
                  Chatfly
                </p>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form>
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full dark:text-white rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                    />
                ...
                <button className="flex dark:text-white w-full items-center justify-center gap-3.5 rounded-lg border border-stroke bg-gray p-4 hover:bg-opacity-50 dark:border-strokedark dark:bg-meta-4 dark:hover:bg-opacity-50">
                  <span>
                    <svg
                      width="20"
                      height="20"
