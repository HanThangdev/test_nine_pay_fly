  ...
  return (
    ...
    >
      ...
      <ul className="list-disc list-inside">
        <li className="mb-1">
          Visit our website at chatfly.co, or any website of ours that links to
          this privacy notice.
        </li>
        <li className="mb-1">
      ...
      <p className="mb-4">
        ...
        have any questions or concerns, please contact us at contact@chatfly.co.
      </p>
      ...
      <p className="mb-4">
        <strong>1. What is the purpose of my data usage?</strong>{' '}
        <p>
          ={'>'} We utilize your data to train the bot to deliver responses that
          align with your preferences. Rest assured, we will never sell your
          data.
        </p>
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        <strong>3. Do you send my data to third-parties?</strong>
        <p>
          {' '}
          ={'>'} We use OpenAI's GPT-3.5 and GPT-4 language models. This means
          that text content within your uploads may, in unmarked chunks, be
          submitted to OpenAI as context when generating a response. We will
          never send your documents in its complete original form to any other
          organization, including OpenAI or its partners.To better explain the
          associated implications, we like to use the analogy of mixing bags of
          legos (chunks of documents) and sending only a mix of blocks to OpenAI
          at a time. In the right combination, your blocks will form your
          original document (like a lego castle). However, when sending to
          OpenAI, your blocks can come from different documents, and they are
          sent alongside thousands of blocks from other users. There is
          basically no way (and no material benefit) for OpenAI to attempt
          reconstructing your blocks and learn of your original documents'
          content. OpenAI has also explicitly stated that it will not use data
          submitted by customers via its API endpoints to train or improve
          models.
        </p>
      </p>
      <p className="mb-4">
        <strong>4. Can you view the documents I upload?</strong>{' '}
        <p>
          ={'>'} Our engineers have the capability to access the documents you
          upload. This access is for debugging and enhancing user experience
          purposes. Rest assured, all of our engineers are bound by strict
          non-disclosure agreements (NDAs), so your data will never be
          distributed in any way.
        </p>
      </p>
      <p className="mb-4">
        <strong>5. Is my data end-to-end encrypted? </strong>
        <p>
          {' '}
          ={'>'} Your data is not end-to-end encrypted when it's stored on our
          servers. This is because encrypting your data would prevent us from
          extracting any meaningful information from it, which would disable
          most of our features. This holds true for text analytics platforms in
          general, including OpenAI itself. Anyone claiming to offer end-to-end
          encryption while providing similar capabilities is not being truthful.
        </p>
      </p>
      <p className="mb-4">
        <strong>
          6. How can you access, modify, or remove the data we collect from you?
        </strong>{' '}
        <p>
      ...
      <p className="mb-4 font-bold text-lg uppercase">1. Definitions</p>
      <p className="mb-2">
        <strong>API</strong> means Chatfly application programming interface to
        be integrated with the User’s software.
      </p>
      <p className="mb-2">
      ...
      <p className="mb-2">
        <strong>Widget</strong> means a Chatbase widget that may be implemented
      ...
      <p className="mb-4 font-bold text-lg uppercase">3. The Data Controller</p>
      <p className="mb-4">
      ...
      <ul className="list-none">
        ...
        <li className="mb-1">
          c. Advertising Cookies: Advertising Cookies are used to serve you with
          advertisements that may be relevant to you and your interests.
        </li>
      </ul>

      <p className="mb-2 font-bold text-lg uppercase">5. Retention of Data</p>
      <p className="mb-4">
        ...
        agreements and policies. Your Personal Data processed upon your consent
        will be stored for as long as the relevant consent is not withdrawn and
        until the expiration of claims resulting from the Service. We will also
        retain Usage Data for internal analysis purposes. Usage Data is
        generally retained for a shorter period, except when this data is used
        to strengthen the security or to improve the functionality of our
        Service, or we are legally obligated to retain this data for longer time
        periods.
      </p>

      <p className="mb-2 font-bold text-lg uppercase">6. Disclosure of Data</p>
      ...
      <ul className="list-none">
        ...
        <li className="mb-1">
          b. If we or our subsidiaries are involved in a merger, acquisition or
          asset sale.
        </li>
        <li className="mb-1">c. To our subsidiaries, affiliates, employees.</li>
        <li className="mb-1">
      ...
      <p className="mb-2 font-bold text-lg uppercase">7. Security of Data</p>
      <p className="mb-4">
        The security of your data is important to us but remember that no method
        of transmission over the Internet or method of electronic storage is
        100% secure. We use appropriate administrative, technical and physical
        safeguards to protect the Personal Data you provide against accidental,
        unlawful or unauthorized destruction, loss, alteration, access,
        disclosure or use, e.g. we maintain backup copies and only authorized
        personnel may access the Personal Data.
      </p>

      <p className="mb-2 font-bold text-lg uppercase">8. Use of Data</p>
      <p className="mb-2">
        The security of your data is important to us but remember that no method
        of transmission over the Internet or method of electronic storage is
        100% secure. We use appropriate administrative, technical and physical
        ...
        unlawful or unauthorized destruction, loss, alteration, access,
        disclosure or use, e.g. we maintain backup copies and only authorized
        personnel may access the Personal Data.Chatfly.co uses the collected
        Personal Data for various purposes:
      </p>
      <ul className="list-none">
        <li className="mb-1">
        ...
        <li className="mb-1">
          b. To notify you about changes to our Service; type of Personal Data:
        ...
        <li className="mb-1">
          ...
          when you choose to do so; type of Personal Data: email address, first
          name and last name, Cookies and Usage Data; necessity for the
          performance of a contract to which you are a party.
        </li>
        <li className="mb-1">
          d. To provide customer support; type of Personal Data: email address,
        ...
        <li className="mb-1">
          ...
          our Service; type of Personal Data: email address, first name and last
          name, Cookies and Usage Data; legitimate interests of the Data
          Controller.
        </li>
        <li className="mb-1">
          f. To monitor the usage of our Service; type of Personal Data: email
          address, first name and last name, Cookies and Usage Data; legitimate
          interests of the Data Controller.
        </li>
        <li className="mb-1">
          g. To detect, prevent and address technical issues; type of Personal
          Data: email address, first name and last name, Cookies and Usage Data;
        ...
        <li className="mb-1">
          ...
          last name, Cookies and Usage Data; necessity for the performance of a
        ...
        <li className="mb-1">
          ...
          Cookies and Usage Data; necessity for the performance of a contract to
        ...
        <li className="mb-1">
          ...
          have opted not to receive such information; type of Personal Data:
          email address, first name and last name, Cookies and Usage Data; upon
          your consent.
        </li>
        <li className="mb-1">
      ...
      <p className="mb-2 font-bold text-lg uppercase">9. Service Providers</p>
      <p className="mb-2">
      ...
      <p className="mb-2 font-bold text-lg uppercase">11. Children's Privacy</p>
      <p className="mb-2">
      ...
      <p className="mb-2">
        ...
        we have posted an updated Privacy Policy, or notified you if applicable,
        you consent to the revised Privacy Policy and practices described in it.
      </p>

      <p className="mb-2 font-bold text-lg uppercase">13. Contact Us</p>
      <p className="mb-2">
